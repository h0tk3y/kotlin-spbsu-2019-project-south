...
1. Общее:
    1. СКОМПИЛИТЬ ЧТО-НИБУДЬ / Решить все проблемы кода в develop(Илья вроде решил часть щас в develop норм)
    1. Что-то решить с тестами - делать не делать
    1. Про UI - ДЛЯ НЕГО ДОДЕЛАЙТЕ Client(а пока Андрей начинает его делать)
